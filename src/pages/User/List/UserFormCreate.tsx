...
type UserFormCreateProps = {
  initialData: UserCreate;
  onSubmit(values: UserCreate, actions: FormikHelpers<UserCreate>): void;
...
const validationSchema = yup.object({
  fullName: yup
    .string()
    .min(3, 'El campo nombre completo debe tener al menos 10 caracteres')
  ...
  password: yup
    .string()
    .min(8, 'El campo apellido debe tener al menos 8 caracteres')
    .required('Se requiere el campo contraseña')
});

const UserFormCreate: FC<UserFormCreateProps> = ({
  initialData,
  onSubmit,
  handleClose
}) => {
